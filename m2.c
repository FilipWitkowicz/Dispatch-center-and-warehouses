...
int main(int argc, char* argv[]){
    ...
    if(pd1 != 0 && pd2 != 0){
        while(1){
            ...
            int desk2 = open("kolejkam2", O_RDONLY);
            int message[4];
            ...
            while(start - stop < czas){
                ...
                if(rozmiar == 16){
                    if(nr_zamowienia == 0){
                        ...
                        // kill(pid_rodz, 14);
                        int desk2 = open("kolejkam2", O_WRONLY);
                        write(desk2, &message, 16);
                        close(desk2);

                        int message2[4];
                        desk2 = open("kolejkam2", O_RDONLY);
